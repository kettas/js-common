...
Calendar.prototype.draw = function() {   
  ...
  mvAry[mvAry.length]  = '    <table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-size:12px;color: #000000;">';   
  mvAry[mvAry.length]  = '      <tr>';   
  mvAry[mvAry.length]  = '        <th align="left" width="1%" style="margin: 0;padding: 0;height: 20px;line-height: 20px;text-align: left;"><input style="border: 1px solid ' + calendar.colors["input_border"] + ';background-color:' + calendar.colors["input_bg"] + ';width:16px;height:20px;';   
  ...
  mvAry[mvAry.length]  = '        <th align="center" width="98%" nowrap="nowrap" style="margin: 0;padding: 0;height: 20px;line-height: 20px;text-align: center;"><select name="calendarYear" id="calendarYear" style="font-size:12px;font-family: 宋体;height: 18px;line-height: 14px;margin: 0;padding: 0;text-align: left;"></select>&nbsp;<select name="calendarMonth" id="calendarMonth" style="font-size:12px;font-family: 宋体;height: 18px;line-height: 14px;margin: 0;padding: 0;text-align: left;';   
  if(calendar.DateMode > pickMode["month"]){mvAry[mvAry.length]  = 'display:none;';}//pickMode 精确到年时隐藏“月”   
  mvAry[mvAry.length]  = '"></select></th>';   
  mvAry[mvAry.length]  = '        <th align="right" width="1%" style="margin: 0;padding: 0;height: 20px;line-height: 20px;text-align: right;"><input style="border: 1px solid ' + calendar.colors["input_border"] + ';background-color:' + calendar.colors["input_bg"] + ';width:16px;height:20px;';   
  if(calendar.DateMode > pickMode["month"]){mvAry[mvAry.length]  = 'display:none;';}//pickMode 精确到年时隐藏“月”   
  mvAry[mvAry.length]  ='" name="nextMonth" type="button" id="nextMonth" value="&gt;" /></th>';   
  mvAry[mvAry.length]  = '      </tr>';   
  mvAry[mvAry.length]  = '    </table>';   
  mvAry[mvAry.length]  = '    <table id="calendarTable" width="100%" style="border:0px solid #CCCCCC;background-color:#FFFFFF;font-size:12px;font-family: 宋体;color: #000000;';   
  ...
  mvAry[mvAry.length]  = '      <tr>';   
  for(var i = 0; i < 7; i++) {   
    mvAry[mvAry.length]  = '      <th style="font-weight:normal;background-color:' + calendar.colors["tr_bg"] + ';color:' + calendar.colors["tr_word"] + ';font-size:12px;font-family: 宋体;height: 14px;margin: 0;padding: 3px;">' + Calendar.language["weeks"][this.lang][i] + '</th>';   
  }   
  mvAry[mvAry.length]  = '      </tr>';   
  for(var i = 0; i < 6;i++){   
    ...
    for(var j = 0; j < 7; j++) {   
      if (j == 0){   
        mvAry[mvAry.length]  = '  <td style="cursor:default;color:' + calendar.colors["sun_word"] + ';font-size:12px;font-family: 宋体;height: 14px;line-height: 14px;margin: 0;padding: 3px;text-align: center;"></td>';   
      } else if(j == 6) {   
        mvAry[mvAry.length]  = '  <td style="cursor:default;color:' + calendar.colors["sat_word"] + ';font-size:12px;font-family: 宋体;height: 14px;line-height: 14px;margin: 0;padding: 3px;text-align: center;"></td>';   
      } else {   
        mvAry[mvAry.length]  = '  <td style="cursor:default;font-size:12px;font-family: 宋体;height: 14px;line-height: 14px;margin: 0;padding: 3px;text-align: center;"></td>';   
      }   
    }   
    mvAry[mvAry.length]  = '    </tr>';   
  }   
...
//添加的代码，放置时间的行   
  mvAry[mvAry.length]  = '      <tr style="';   
    ...
    mvAry[mvAry.length]  = '"><td align="center" colspan="7" style="margin: 0;padding: 3px;height: 18px;line-height: 18px;text-align: center;">';   
  mvAry[mvAry.length]  = '      <select name="calendarHour" id="calendarHour" style="font-size:12px;font-family: 宋体;height: 18px;line-height: 14px;margin: 0;padding: 0;text-align: left;"></select>' + Calendar.language["hour"][this.lang];   
  mvAry[mvAry.length]  = '<span style="'  
    if(calendar.DateMode >= pickMode["hour"]){mvAry[mvAry.length]  = 'display:none;';}//pickMode 精确到小时时隐藏“分”   
  mvAry[mvAry.length]  = '"><select name="calendarMinute" id="calendarMinute" style="font-size:12px;font-family: 宋体;height: 18px;line-height: 14px;margin: 0;padding: 0;text-align: left;"></select>' + Calendar.language["minute"][this.lang]+'</span>';   
    mvAry[mvAry.length]  = '<span style="'  
    if(calendar.DateMode >= pickMode["minute"]){mvAry[mvAry.length]  = 'display:none;';}//pickMode 精确到小时、分时隐藏“秒”   
   mvAry[mvAry.length]  = '"><select name="calendarSecond" id="calendarSecond" style="font-size:12px;font-family: 宋体;height: 18px;line-height: 14px;margin: 0;padding: 0;text-align: left;"></select>'+ Calendar.language["second"][this.lang]+'</span>';   
  mvAry[mvAry.length]  = '      </td></tr>';   
  mvAry[mvAry.length]  = '    </table>';   
  mvAry[mvAry.length]  = '      <div align="center" style="margin: 0;padding:4px 4px 4px 4px;height: 20px;line-height: 20px;text-align: center;background-color:' + calendar.colors["input_bg"] + ';">';   
...
Calendar.prototype.show = function (dateObj, popControl) {   
  ...
  {   
    ...
    this.dateControl.blurEvent = this.dateControl.onblur;}//onblur ，使其原本的事件不被覆盖   
